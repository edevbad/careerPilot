...
export default function CareerAssessment() {
  ...
  const [form, setForm] = useState({
    careerGoal: '', skillLevel: '', interests: '', duration: '',
  ...
  return (
    <div className={styles.page}>
      ...
      <p className={styles.sub}>Tell us about yourself and we'll build your AI-powered roadmap.</p>
      ...
      <Card>
        <form onSubmit={handleSubmit} className={styles.form}>
          ...
          <div className={styles.field}>
            ...
            <select className={styles.select} value={form.careerGoal}
              onChange={(e) => handleChange('careerGoal', e.target.value)} required>
          ...
          <div className={styles.field}>
            ...
            <textarea className={styles.textarea} rows={3}
              placeholder="e.g. I enjoy building APIs, I have some JavaScript experience..."
